...
class trainer():
    def __init__(self, models, loss_funcs, optimizers, optimizers_after, XYtrainLoader, XYvalidLoader, XYtestLoader, prior,args):
        self.models = models
...
def main():
    ...
    # training
    PUtrainer = trainer(models, loss_funcs, optimizers, optimizers_after,
